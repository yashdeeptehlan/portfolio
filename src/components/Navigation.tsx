...
const Navigation: React.FC<NavigationProps> = ({ activeSection, isMenuOpen, setIsMenuOpen }) => {
  ...
  return (
    <motion.nav
      className="fixed left-0 right-0 top-0 z-50 border-b border-slate-800/80 bg-[#090c10]/90 backdrop-blur"
    ...
    >
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            className="border-t border-slate-800 bg-[#090c10] px-4 py-4 lg:hidden"
